    ...
    <div class="max-w-4xl mx-auto p-4">
        ...
        <form action="{{ route('note.update', $note) }}" method="POST">
            ...
            <div class="bg-white dark:bg-gray-900 rounded-md p-4">
                ...
                <textarea id="title" name="title" rows="2" maxlength="200" class="w-full text-gray-600 dark:text-white dark:bg-gray-900 resize-none rounded-md" placeholder="Title">{{ $note->title }}</textarea>
                ...
                <textarea required id="note" name="note" rows="10" maxlength="65535" class="w-full text-gray-600 dark:text-white dark:bg-gray-900 resize-none rounded-md" placeholder="Contents">{{ $note->note }}</textarea>
